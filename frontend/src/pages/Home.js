...
function Home() {
  ...
  return (
    <div className='h-screen font-mont w-full bg-gray-800'>
      <LoadingBar color='#FF6347' ref={ref}></LoadingBar>
      ...
      <div className='Feed w-4/5 left-[calc(100%-90%)] relative h-[calc(100%-6rem)] flex'>
        ...
        <div className='rightbox flex flex-col gap-10 items-center w-1/2'>
          {/* /////////////////////////// */}
          <div className='createnew bg-gray-900 w-auto rounded-3xl p-10 pb-6 pt-6 flex flex-col justify-center items-center gap-2 relative top-5'>
            ...
            <div className='flex flex-row gap-4'>
              <input
                ...
                placeholder='Amount'
                className='h-12 w-auto text-base placeholder-black p-4 rounded-xl outline-none focus:outline-none focus:ring-2 focus:ring-orange-500'
              />
              <select
                id="countries"
                onChange={(e) => { setCategory(e.target.value); console.log(category); }}
                defaultValue='selected'
                className="bg-white w-auto outline-none border placeholder-black border-gray-300 text-gray-900 text-sm rounded-xl block p-2.5 focus:outline-none focus:ring-2 focus:ring-orange-500"
              >
            ...
            <div className='grid grid-flow-col w-full'>
              <div className='w-full'>
                <DatePicker
                  ...
                  className="p-3 placeholder-black w-2/2 rounded-xl outline-none bg-gray-700 px-4 placeholder-yellow-500 h-fit text-white focus:ring-2 focus:ring-orange-500"
              ...
              <a
                ...
                href="#_"
                className="relative h-fit text-center w-full rounded-xl px-5 py-2 overflow-hidden group bg-gray-700 border-2 hover:bg-gradient-to-r hover:from-indigo-600 hover:to-indigo-600 text-white hover:ring-2 hover:ring-offset-2 hover:ring-indigo-600 transition-all ease-out duration-300"
              >
